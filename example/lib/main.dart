...
class _FlutterContactsExampleState extends State<FlutterContactsExample> {
  ...
  @override
  Widget build(BuildContext context) => MaterialApp(home: Scaffold(appBar: AppBar(title: Text('flutter_contacts_example')), body: _body()));
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, i) => ListTile(
            ...
            onTap: () async {
              ...
              print("laallalal>>> ${contacts.length}");
              ...
              print("laallalal>>> ${fullContact}");

              // await Navigator.of(context).push(MaterialPageRoute(builder: (_) => FlutterContactsExample()));
            }));
  }
}
